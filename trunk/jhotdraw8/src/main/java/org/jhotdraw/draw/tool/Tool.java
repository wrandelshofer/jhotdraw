...
public interface Tool extends PropertyBean, Disableable {
  ...
  /** 
   ...
   /** 
     ...
     * {@code RadioButton</code> and <code>CheckBox} make use of
     * this but instances of {@code Menu} don't.
     */
    ...
    * By convention, this property is only set by {@code DrawingView}.
     * @return the drawingView property, with {@code getBean()} returning this tool,
     * and {@code getLabel()} returning {@code DRAWING_VIEW_PROPERTY}.
    */
