...
public class DOMRule {
    ...
    public DOMRule(String name, String value) {
        properties = new HashMap<String,String>();
        properties.put(name, value);
    }
    public DOMRule(String selector, String propertyName, String propertyValue) {
        setSelector(selector);
        properties = new HashMap<String,String>();
        properties.put(propertyName, propertyValue);
    }
    public DOMRule(String selector, Map<String,String> properties) {
        setSelector(selector);
