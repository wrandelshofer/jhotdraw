...
import org.jhotdraw.draw.figure.TextableFigure;
...
public class GrapherView extends AbstractView implements EditorView {
    ...
    public void init() {
        ...
        ttbar.addTool(new CreationTool("edit.createRectangle", rsrc, ()->{RectangleFigure rf=new RectangleFigure();
        ArrayList<Transform> ts=new ArrayList<>();
        ts.add(new Rotate(45,0,0));
        rf.set(TransformableFigure.TRANSFORMS, ts);
        return rf;
        }, layerFactory), 4, 0);
