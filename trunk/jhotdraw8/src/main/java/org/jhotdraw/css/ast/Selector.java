...
public abstract class Selector extends AST {
   ...
   * </ul>
   * <p>
   * Selectors inside the negation pseudo-class are counted like any other, but
   * the negation itself does not count as a pseudo-class.
   * <p>
   * Concatenating the three numbers a-b-c (in a number system with a large
   * base) gives the specificity.
   * <p>
   * In this implementation we compute specificity with {@code specificity=100*a+10*b+c}.
   * <p>
   * References:
   * <ul>
   ...
   */
  protected abstract <T> MatchResult<T> match(SelectorModel<T> model, T element);
}
