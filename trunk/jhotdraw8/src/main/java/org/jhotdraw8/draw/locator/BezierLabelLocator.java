...
public class BezierLabelLocator implements Locator {
     ...
     *
     * @param relativePosition The relative position of the label on the
     * polyline. 0.0 specifies the start of the bezier path, 1.0 the end of the
     * polyline. Values between 0.0 and 1.0 are relative positions on the bezier
     * path.
    ...
    /**
     * Returns the coordinates of the relative point on the path of the
     * specified bezier figure.
     *
    ...
    /**
     * Returns aPoint2D on the polyline that is at the provided relative
     * position. XXX - Implement this and move it to BezierPath
     *
     * @param owner the owner
