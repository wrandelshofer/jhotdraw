    ...
    public List<DynamicTest> parseNonnullFactory() {
        return Arrays.asList(
                ...
                dynamicTest("2", () -> parseNonnull("{\"key\":[\"value\"]}",
                        new MLCompartmentalizedData(ImmutableMap.of("key", ImmutableLists.of("value"))))),
                dynamicTest("3", () -> parseNonnull("{\"key\":[\"value1\",\"value2\"]}",
                        new MLCompartmentalizedData(ImmutableMap.of("key", ImmutableLists.of("value1", "value2"))))),
                dynamicTest("4", () -> parseNonnull("{\"k1\":[\"v11\",\"v12\"],\"k2\":[\"v21\"]}",
                        new MLCompartmentalizedData(ImmutableMap.of("k1", ImmutableLists.of("v11", "v12"), "k2", ImmutableLists.of("v21"))))),
                // unquoted keys
