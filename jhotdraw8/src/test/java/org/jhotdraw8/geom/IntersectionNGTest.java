...
public class IntersectionNGTest {
    ...
    public void testIntersectLineBezier2_5args() {
        ...
        Intersection result = Intersections.intersectLineBezier2(a1, a2, p1, p2, p3);
        System.out.println(result.getPoints());
        System.out.println(result.getTs());
        System.out.println("bezier2->line");
        result = Intersections.intersectBezier2Line(p1, p2, p3, a1, a2);
        System.out.println(result.getPoints());
        System.out.println(result.getTs());
        System.out.println("line->line");
        result = Intersections.intersectLineLine(a1, a2, p1, p3);
        System.out.println(result.getPoints());
        System.out.println(result.getTs());
