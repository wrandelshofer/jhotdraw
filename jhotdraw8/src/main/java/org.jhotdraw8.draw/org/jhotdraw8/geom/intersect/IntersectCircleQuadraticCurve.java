...
public class IntersectCircleQuadraticCurve {
    private IntersectCircleQuadraticCurve() {
    }
    ...
    public static IntersectionResultEx intersectQuadraticCurveCircleEx(@NonNull Point2D p0, @NonNull Point2D p1, @NonNull Point2D p2, @NonNull Point2D c, double r) {
        return IntersectEllipseQuadraticCurve.intersectQuadraticCurveEllipseEx(p0, p1, p2, c, r, r);
    }
    ...
    public static IntersectionResultEx intersectQuadraticCurveCircleEx(
        ...
        return IntersectEllipseQuadraticCurve.intersectQuadraticCurveEllipseEx(new Point2D.Double(x0, y0), new Point2D.Double(x1, y1), new Point2D.Double(x2, y2), new Point2D.Double(cx, cy), r, r);
    }
}
