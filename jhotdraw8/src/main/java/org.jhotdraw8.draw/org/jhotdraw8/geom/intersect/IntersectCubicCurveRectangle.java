...
public class IntersectCubicCurveRectangle {
    ...
    public static IntersectionResultEx intersectCubicCurveRectangleEx(@NonNull Point2D p0, @NonNull Point2D p1, @NonNull Point2D p2, @NonNull Point2D p3, @NonNull Point2D r0, @NonNull Point2D r1) {
        ...
        inter1 = IntersectCubicCurveLine.intersectCubicCurveLineEx(p0, p1, p2, p3, topLeft, topRight);
        inter2 = IntersectCubicCurveLine.intersectCubicCurveLineEx(p0, p1, p2, p3, topRight, bottomRight);
        inter3 = IntersectCubicCurveLine.intersectCubicCurveLineEx(p0, p1, p2, p3, bottomRight, bottomLeft);
        inter4 = IntersectCubicCurveLine.intersectCubicCurveLineEx(p0, p1, p2, p3, bottomLeft, topLeft);
