...
public interface SecondStrokeCuttableFigure extends Figure {
     ...
     */
    @Nullable CssSizeStyleableKey SECOND_STROKE_CUT_START = new CssSizeStyleableKey("second-stroke-cut-start", DirtyMask.of(DirtyBits.NODE), CssSize.ZERO);
    /**
     * Cuts off the specified number of pixels from the end of the stroked path.
     */
    @Nullable CssSizeStyleableKey SECOND_STROKE_CUT_END = new CssSizeStyleableKey("second-stroke-cut-end", DirtyMask.of(DirtyBits.NODE), CssSize.ZERO);
    /**
