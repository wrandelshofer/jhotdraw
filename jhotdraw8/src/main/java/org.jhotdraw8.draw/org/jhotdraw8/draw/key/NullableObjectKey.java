...
public class NullableObjectKey<T> extends ObjectKey<T> {
     ...
     */
    public NullableObjectKey(@Nonnull String key, @Nonnull Class<T> clazz, @Nonnull DirtyMask dirtyMask) {
     ...
     */
    public NullableObjectKey(@Nonnull String key, @Nonnull Class<T> clazz, @Nonnull DirtyMask dirtyMask, @Nullable T defaultValue) {
     ...
     * @param dirtyMask      the dirty bits
     */
    public NullableObjectKey(@Nonnull String name, @Nonnull Class<?> clazz, @Nullable Class<?>[] typeParameters, @Nonnull DirtyMask dirtyMask, @Nullable T defaultValue) {
