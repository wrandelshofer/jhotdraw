...
/**
 * Represents a hex color in a cascading stylesheet.
 * <p>
 * References:
 * <dl>
 ...
 * </dl>
 */
public class HexColor extends CssColor {
    private HexColor(int argb) {
        super(HexColor.toName(argb),
                Color.rgb(argb >> 16 & 0xff, argb >> 8 & 0xff, argb % 0xff,
                        (argb >> 24 & 0xff) / 255.0));
    }

    public HexColor(int r, int g, int b, int a) {
        super(HexColor.toName((a & 0xff) << 24 | (r & 0xff) << 16 | (g & 0xff) << 8 | b & 0xff),
    ...
    private static String toName(int argb) {
        ...
        if ((argb & 0xff000000) == 0xff000000) {
            // the color is opaque
            if ((argb & 0xf0f0f0) == (argb & 0x0f0f0f << 8)) {
            ...
            if ((argb & 0xf0f0f0f0) == (argb & 0x0f0f0f0f) << 8) {
