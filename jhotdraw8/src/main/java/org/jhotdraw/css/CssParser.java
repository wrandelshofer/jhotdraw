...
import org.jhotdraw.css.ast.PreservedToken;
 ...
 * <p>
 * The CSS Syntax Module Level 3 defines a grammar which is equivalent to
 * the following EBNF ISO/IEC 14977 productions:
 * <pre>
...
public class CssParser {
    ...
    private List<PreservedToken> parseTerms(CssTokenizer tt) throws IOException, ParseException {
        List<PreservedToken> terms = new ArrayList<>();
        tt.nextToken();
        skipWhitespace(tt);
        tt.pushBack();
    ...
    private PreservedToken parseTerm(CssTokenizer tt) throws IOException, ParseException {
        switch (tt.nextToken()) {
