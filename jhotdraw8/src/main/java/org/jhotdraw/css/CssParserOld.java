...
import org.jhotdraw.css.ast.AttributeSelector;
import org.jhotdraw.css.ast.AbstractAttributeSelector;
import org.jhotdraw.css.ast.AttributeValueEqualsSelector;
 ...
 * References:
 * <ul>
 * <li><a href="http://www.w3.org/TR/2011/REC-CSS2-20110607">W3C CSS2</a></li>
...
public class CssParserOld {
    ...
    private AbstractAttributeSelector parseAttributeSelector(StreamPosTokenizer tt) throws IOException {
        ...
        case '~':
            ...
            selector = new IncludeMatchSelector(attributeName, tt.sval);
            break;
        case '|':
            if (tt.nextToken() != '=') {
                throw new IOException("AttributeSelector: '=' instead of " + value(tt) + " expected in line " + tt.lineno());
            ...
            selector = new DashMatchSelector(attributeName, tt.sval);
            break;
        case ']':
