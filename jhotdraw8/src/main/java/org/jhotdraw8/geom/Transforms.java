...
public class Transforms {
    /**
     * Decomposes the given transformation matrix into
     *  rotation, followed by scale and then translation.
     * Returns the matrix if the decomposition fails.
     * Returns an empty list if the transform is the identity matrix.
     * 
