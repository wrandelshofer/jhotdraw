...
public class Dimension2DDouble extends Dimension2D implements java.io.Serializable {
    ...
    /**
     * Creates an instance of <code>Dimension2DDouble</code> with a width of
    ...
    /**
     * Creates an instance of <code>Dimension2DDouble</code> whose width and
     * height are the same as for the specified dimension.
     *
     * @param d the specified dimension for the <code>width</code> and
    ...
    /**
     * Constructs a <code>Dimension2DDouble</code> and initializes it to the
    ...
    /**
     * Sets the size of this <code>Dimension2DDouble</code> object to the
     ...
     * @param height the new height for the <code>Dimension2DDouble</code>
     * object
     */
    @Override
    ...
    /**
     * Gets the size of this <code>Dimension2DDouble</code> object. This method
     * is included for completeness, to parallel the <code>getSize</code> method
