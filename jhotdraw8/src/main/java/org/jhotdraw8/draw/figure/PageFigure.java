...
public class PageFigure extends AbstractCompositeFigure implements Page, Group, TransformableFigure, ResizableFigure, HideableFigure, LockableFigure, StyleableFigure {
  ...
  private double computeContentAreaFactor() {
    ...
    double contentAreaWidth = (get(PAPER_WIDTH).getDefaultConvertedValue() - insets.getLeft() - insets.getRight()) * numPagesX;
    double contentAreaHeight = (get(PAPER_HEIGHT).getDefaultConvertedValue() - insets.getTop() - insets.getBottom()) * numPagesY;
