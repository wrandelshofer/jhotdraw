...
public interface SecondStrokeCuttableFigure extends Figure {
    ...
    public final static CssSizeStyleableFigureKey SECOND_STROKE_CUT_START = new CssSizeStyleableFigureKey("second-stroke-cut-start", DirtyMask.of(DirtyBits.NODE), CssSize.ZERO);
    /** Cuts off the specified number of pixels from the end of the stroked path. */
    public final static CssSizeStyleableFigureKey SECOND_STROKE_CUT_END = new CssSizeStyleableFigureKey("second-stroke-cut-end", DirtyMask.of(DirtyBits.NODE), CssSize.ZERO);
    /** Cuts off the specified number of pixels from the start and the end of the stroked path. */
    public static SymmetricCssPoint2DStyleableMapAccessor SECOND_STROKE_CUT = new SymmetricCssPoint2DStyleableMapAccessor("second-stroke-cut", SECOND_STROKE_CUT_START, SECOND_STROKE_CUT_END);
