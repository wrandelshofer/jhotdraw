 ...
 * @version $$Id$$
 */
public class PageLabelFigure extends AbstractLabelFigure implements FontableFigure, StyleableFigure, LockableFigure, TransformableFigure, CompositableFigure {
