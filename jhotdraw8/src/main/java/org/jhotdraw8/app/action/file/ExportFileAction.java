...
public class ExportFileAction extends AbstractSaveFileAction {
     ...
     * @param view the view
     */
    public ExportFileAction(Application app, DocumentOrientedActivityViewController view) {
     ...
     * @param optionsDialog the dialog for specifying export options
     */
    public ExportFileAction(Application app, DocumentOrientedActivityViewController view, String id, Function<DataFormat, Dialog<Map<? super Key<?>, Object>>> optionsDialog) {
...
@Override
    ...
    @Override
    protected void handleSucceded(DocumentOrientedActivityViewController v, URI uri, DataFormat format) {
        // empty
    }
}
