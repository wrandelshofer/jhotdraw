...
public class JMixer extends javax.swing.JPanel {
    ...
    private JList<Color> swatchesList;
    ...
    public JMixer() {
        ...
        swatchesList = new JList<>() {
            ...
            public String getToolTipText(MouseEvent evt) {
                ...
                // Get item
                Color item = getModel().getElementAt(index);
        ...
        swatchesList.setModel((ListModel<Color>) harmonicWheel.getHarmonicColorModel());
    ...
    private javax.swing.JComboBox<Preset> presetCombo;
