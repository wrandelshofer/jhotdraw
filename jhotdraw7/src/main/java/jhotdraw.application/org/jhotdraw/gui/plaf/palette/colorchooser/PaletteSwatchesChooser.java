...
public class PaletteSwatchesChooser extends AbstractColorChooserPanel {
    ...
    private javax.swing.JList<ColorIcon> jList;
    // End of variables declaration//GEN-END:variables

    @Override
    public void updateChooser() {
        if (updateRecursion++ == 0) {
            ListModel<ColorIcon> m = jList.getModel();
            ...
            if (mc != null) {
                ...
                for (int i = 0, n = m.getSize(); i < n; i++) {
                    ColorIcon item = m.getElementAt(i);
    ...
    protected void buildChooser() {
        ...
        ColorIcon[] byRows=HSB_COLORS_AS_RGB.toArray(new ColorIcon[0]);
        ColorIcon[] byColumns=new ColorIcon[byRows.length];
        ...
        jList.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (updateRecursion++ == 0) {
                    ColorIcon item = jList.getSelectedValue();
