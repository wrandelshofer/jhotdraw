...
public class ToolBarButtonFactory {
    ...
    public static void addColorButtonTo(JToolBar bar, DrawingEditor editor, AttributeKey attributeKey, Map<String,Color> colorMap, int columnCount, String labelKey, ResourceBundleUtil labels) {
        ...
        for (Map.Entry<String,Color> entry : colorMap.entrySet()) {
            ...
            popupButton.add(a=
                    new org.jhotdraw.draw.action.AttributeAction(
                            editor,
                            attributeKey,
                            entry.getValue(),
        ...
        popupButton.setIcon(new ColorAttributeIcon(editor,
                attributeKey,
                labels.getLargeIconProperty(labelKey, ToolBarButtonFactory.class).getImage()
        ));
        ...
        for (int i=0; i < widths.length; i++) {
            ...
            strokeWidthPopupButton.add(
                    new org.jhotdraw.draw.action.AttributeAction(
                            ...
                            new Double(widths[i]),
                            label,
                            new org.jhotdraw.draw.action.StrokeIcon(new BasicStroke((float) widths[i], BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL))
                    )
            );
        }
        ...
        for (int i=0; i < decorations.length; i++) {
            strokeDecorationPopupButton.add(
                    new org.jhotdraw.draw.action.AttributeAction(
                            ...
                            decorations[i],
                            null,
                            new org.jhotdraw.draw.action.LineDecorationIcon(decorations[i], true)
                    )
            );
            strokeDecorationPopupButton.add(
                    new org.jhotdraw.draw.action.AttributeAction(
        ...
        for (int i=0; i < dashes.length; i++) {
            ...
            strokeDashesPopupButton.add(
                    new org.jhotdraw.draw.action.AttributeAction(
                            ...
                            dashes[i],
                            null,
                            new org.jhotdraw.draw.action.StrokeIcon(new BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 10f, fdashes, 0))
                    )
            );
        }
    ...
    public static void addStrokeTypeButtonTo(JToolBar bar, DrawingEditor editor) {
        ...
        strokeTypePopupButton.add(
                new org.jhotdraw.draw.action.AttributeAction(
                        ...
                        new org.jhotdraw.draw.action.StrokeIcon(new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL))
                )
        );
        HashMap<AttributeKey<?>,Object> attr = new HashMap<AttributeKey<?>,Object>();
        attr.put(STROKE_TYPE, StrokeType.DOUBLE);
    ...
    public static void addStrokePlacementButtonTo(JToolBar bar, DrawingEditor editor) {
        ...
        attr = new HashMap<AttributeKey<?>,Object>();
        attr.put(STROKE_PLACEMENT, StrokePlacement.CENTER);
        attr.put(FILL_UNDER_STROKE, Underfill.CENTER);
        ...
        attr = new HashMap<AttributeKey<?>,Object>();
        attr.put(STROKE_PLACEMENT, StrokePlacement.INSIDE);
        attr.put(FILL_UNDER_STROKE, Underfill.CENTER);
        /*strokePlacementPopupButton.add(
                new org.jhotdraw.draw.action.AttributeAction(
                editor,
        ...
        attr = new HashMap<AttributeKey<?>,Object>();
        attr.put(STROKE_PLACEMENT, StrokePlacement.OUTSIDE);
        attr.put(FILL_UNDER_STROKE, Underfill.CENTER);
        /*strokePlacementPopupButton.add(
                new org.jhotdraw.draw.action.AttributeAction(
                editor,
        ...
        attr = new HashMap<AttributeKey<?>,Object>();
        attr.put(STROKE_PLACEMENT, StrokePlacement.CENTER);
        attr.put(FILL_UNDER_STROKE, Underfill.FULL);
        /*strokePlacementPopupButton.add(
                new org.jhotdraw.draw.action.AttributeAction(
                editor,
                attr,
        ...
        attr = new HashMap<AttributeKey<?>,Object>();
        attr.put(STROKE_PLACEMENT, StrokePlacement.CENTER);
        attr.put(FILL_UNDER_STROKE, Underfill.NONE);
        /*strokePlacementPopupButton.add(
                new org.jhotdraw.draw.action.AttributeAction(
                editor,
                attr,
    ...
    public static void addFontButtonsTo(JToolBar bar, DrawingEditor editor) {
        ...
        boldToggleButton.addActionListener(new org.jhotdraw.draw.action.AttributeToggler(editor,
                FONT_BOLD, Boolean.TRUE, Boolean.FALSE,
                new StyledEditorKit.BoldAction()
        ));
        italicToggleButton.addActionListener(new org.jhotdraw.draw.action.AttributeToggler(editor,
    ...
    public static void addAlignmentButtonsTo(JToolBar bar, final DrawingEditor editor) {
        ...
        bar.add(new org.jhotdraw.draw.action.AlignAction.West(editor)).setFocusable(false);
        bar.add(new org.jhotdraw.draw.action.AlignAction.East(editor)).setFocusable(false);
        bar.add(new org.jhotdraw.draw.action.AlignAction.Horizontal(editor)).setFocusable(false);
        bar.add(new org.jhotdraw.draw.action.AlignAction.North(editor)).setFocusable(false);
        bar.add(new org.jhotdraw.draw.action.AlignAction.South(editor)).setFocusable(false);
        bar.add(new AlignAction.Vertical(editor)).setFocusable(false);
        bar.addSeparator();
        bar.add(new org.jhotdraw.draw.action.MoveAction.West(editor)).setFocusable(false);
        bar.add(new org.jhotdraw.draw.action.MoveAction.East(editor)).setFocusable(false);
        bar.add(new org.jhotdraw.draw.action.MoveAction.North(editor)).setFocusable(false);
        ...
        view.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                if (evt.getPropertyName() == "gridConstrainer") {
                    ...
                    toggleGridButton.setSelected(false);
                }
            }
        });
