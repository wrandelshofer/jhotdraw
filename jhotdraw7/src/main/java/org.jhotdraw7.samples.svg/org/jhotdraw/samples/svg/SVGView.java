...
public class SVGView extends AbstractView {
    ...
    public void write(URI uri, URIChooser chooser) throws IOException {
        OutputFormat selectedFormat = null;
        if (chooser instanceof JFileURIChooser) {
            JFileURIChooser fc = (JFileURIChooser) chooser;
            HashMap<javax.swing.filechooser.FileFilter, OutputFormat> fileFilterOutputFormatMap =
            (HashMap<javax.swing.filechooser.FileFilter, OutputFormat>) fc.getClientProperty(SVGApplicationModel.OUTPUT_FORMAT_MAP_CLIENT_PROPERTY);
            selectedFormat = (fileFilterOutputFormatMap == null) ? null : fileFilterOutputFormatMap.get(fc.getFileFilter());
        }
