...
public class UMLPanelBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        // Here you can add code for customizing the BeanDescriptor.
         if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(UMLPanelBeanInfo.class);
         beanDescriptor.setValue("isContainer", Boolean.FALSE);
     beanDescriptor.setDisplayName("UMLPanel");
