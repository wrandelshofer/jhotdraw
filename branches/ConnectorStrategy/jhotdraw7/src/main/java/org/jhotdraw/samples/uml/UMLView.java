 ...
 * @version $Id: UMLView.java,v 1.1 2009/10/18 20:41:49 cfm1 Exp $
 */
public class UMLView extends AbstractView {

    /**
     * Each UMLView uses its own undo redo manager.
    ...
    protected Drawing createDrawing() {
        ...
        DOMStorableInputOutputFormat ioFormat =
                new DOMStorableInputOutputFormat(new UMLFigureFactory());
